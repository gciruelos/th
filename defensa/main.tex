...
\begin{defes}[Equivalencia por permutaciones]
  Decimos que dos secuencias de reducción $\rho, \sigma$ son \defn{equivalentes por permutación} si $\rho/\sigma = \sigma/\rho = \epsilon$.
...
se puede factorizar de manera única en $\rho = \rho_1 \rho_2$ donde
