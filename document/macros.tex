...
%%  TODO BORRAR
\newcommand{\pablo}[1]{\textcolor{purple}{#1}}
\newcommand{\cpablo}[2]{\textcolor{purple}{\sout{#1}\,#2}}
\newcommand{\gonza}[1]{\textcolor{blue}{#1}}
\newcommand{\NotNow}[1]{}

\newenvironment{pabloenv}{\color{purple}}{\ignorespacesafterend}
\newenvironment{gonzaenv}{\color{blue}}{\ignorespacesafterend}
