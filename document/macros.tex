...
\newcommand{\rlem}[1]{Lem.~\ref{lemma:#1}}
\newcommand{\ldef}[1]{\label{def:#1}}
\newcommand{\rdef}[1]{Def.~\ref{def:#1}}
\newcommand{\lprop}[1]{\label{prop:#1}}
\newcommand{\rprop}[1]{Prop.~\ref{prop:#1}}
\newcommand{\lthm}[1]{\label{thm:#1}}
\newcommand{\rthm}[1]{Thm.~\ref{thm:#1}}
...
\newcommand{\labelset}{\mathscr{E}}
\newcommand{\lab}{e}
\newcommand{\labtwo}{e'}
\newcommand{\labthree}{e''}
...
\newcommand{\SeeAppendix}{\textcolor{red}{$\clubsuit$}\xspace}
