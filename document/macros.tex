...
\newcommand{\rlem}[1]{Lem.~\expandafter\uppercase\expandafter{\ref{lemma:#1}}}
\newcommand{\ldef}[1]{\expandafter\uppercase\expandafter{\label{def:#1}}}
\newcommand{\rdef}[1]{Def.~\expandafter\uppercase\expandafter{\ref{def:#1}}}
\newcommand{\lprop}[1]{\expandafter\uppercase\expandafter{\label{prop:#1}}}
\newcommand{\rprop}[1]{Prop.~\expandafter\uppercase\expandafter{\ref{prop:#1}}}
\newcommand{\lthm}[1]{\expandafter\uppercase\expandafter{\label{thm:#1}}}
\newcommand{\rthm}[1]{Thm.~\expandafter\uppercase\expandafter{\ref{thm:#1}}}
\newcommand{\lremark}[1]{\label{remark:#1}}
\newcommand{\rremark}[1]{Rem.~\ref{remark:#1}}
\newcommand{\lcoro}[1]{\label{coro:#1}}
\newcommand{\rcoro}[1]{Coro.~\ref{coro:#1}}
...
\newcommand{\rlempart}[2]{Lem.~\ref{lemma:#1}~(\ref{part:#2})}
