...
not only a natural number. The terms are equipped with two rewriting rules,
one that says how to add and another that says how to multiply:
\[
...
Actually, to be completely formal we should say that the rewriting rules are the \emph{contextual closures}
...
These steps are formally different, but do the same work. We can formalize this notion:
